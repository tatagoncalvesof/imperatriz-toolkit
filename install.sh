...
echo ""
echo "👑 Imperatriz Toolkit — instalando 6 skills no Claude Code"
echo ""
...
echo "  /briefing-copy-360"
echo "  /mecanismo-unico"
echo "  /headline-imperatriz"
echo "  /texto-em-visual"
echo "  /analise-anuncio-1000"
echo "  /stories-pergunta-resposta"
echo ""
